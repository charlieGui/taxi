...
<div>
    ...
    <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet <strong>https://www.abcdtaxi.fr</strong> l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi:<br><br>
        ...
        <strong>Propriétaire du site :</strong> ABCD Taxi, société par actions simplifié ( Société à associé unique)<br>
        ...
        <strong>Autentification de l'entreprise :</strong> SAS ABCD Taxi, société par actions simplifié ( Société à associé unique) au capital social de 1800€ - RCS ou RM : 919 139 600 R.C.S. Romans.<br> 
    ...
    <p><strong>ABCD Taxi</strong>, ne pourra être tenu pour responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site <a href="index.php">https://www.abcdtaxi.fr</a>.
    <strong>ABCD Taxi</strong>,  décline toute responsabilité quant à l’utilisation qui pourrait être faite des informations et contenus présents sur <a href="index.php">https://www.abcdtaxi.fr</a>.
    <strong>ABCD Taxi</strong>,  s’engage à sécuriser au mieux le site <a href="index.php">https://www.abcdtaxi.fr</a>, cependant sa responsabilité ne pourra être mise en cause si des données indésirables sont importées et installées sur son site à son insu.
    ...
    <p>Conformément aux dispositions de la loi 78-17 du 6 janvier 1978 modifiée, l’utilisateur du site <a href="index.php">https://www.abcdtaxi.fr</a> dispose d’un droit d’accès, de modification et de suppression des informations collectées. Par ailleurs, ce site n'effectue aucune collecte de données en l'état.</p>
        
    <h2>5 - Droit applicable et attribution de juridiction.</h2>
    <p>Tout litige en relation avec l’utilisation du site <a href="index.php">https://www.abcdtaxi.fr</a> est soumis au droit français. En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux compétents de Valence.</p>
</div>